<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<c:url value="/templates/admin/assets" var="url"></c:url>
<!-- BEGIN HEADER -->
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner container-fluid">
		...
		<div class="page-logo">
			...
			<a href="#"> <img src="${url}/admin/layout2/img/logoXanh_remove.png"
		...
		<div class="page-actions">
			<div class="btn-group">
				<button type="button"
					class="btn btn-circle red-pink dropdown-toggle hide"
			...
			<div class="btn-group">
				<button type="button" class="btn btn-circle green-haze"
					data-toggle="dropdown">
					<i class="fa fa-plus"></i>&nbsp;<span class="hidden-sm hidden-xs">New&nbsp;</span>&nbsp;<i
						class="fa fa-angle-down"></i>
				</button>
				<ul class="dropdown-menu pull-left" role="menu">
					<li><a href="<c:url value="/admin-product_types"></c:url>"> <i
							class="icon-tag"></i> New Product Types
					</a></li>
					<li><a href="<c:url value="/admin-users"></c:url>"> <i
							class="icon-users"></i> New Users
					</a></li>
					<li><a href="<c:url value="/admin-products"></c:url>"> <i
							class="icon-docs"></i> New Products
					</a></li>
					<li><a href="<c:url value="/admin-suppliers"></c:url>"> <i
							class="icon-docs"></i> New Suppliers
					</a></li>
					<li><a href="<c:url value="/admin-skins"></c:url>"> <i
							class="icon-docs"></i> New Skins
					</a></li>
					<li class="divider"></li>
				...
				<ul class="nav navbar-nav pull-right">
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;"
									...
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="${url}/admin/layout3/img/avatar2.jpg"
									...
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="${url}/admin/layout3/img/avatar3.jpg"
												class="img-circle" alt="">
									...
									<li><a href="inbox.html?a=view"> <span class="photo">
												<img src="${url}/admin/layout3/img/avatar1.jpg"
												class="img-circle" alt="">
					...
					<li class="dropdown dropdown-user"><a href="#"
						...
						data-hover="dropdown" data-close-others="true"> <img alt=""
							class="img-circle"
							src="<c:url value="/${sessionScope.acc.images}"/>" /> <span
							class="username username-hide-on-mobile">
								${sessionScope.acc.fullname} </span> <i class="fa fa-angle-down"></i>
					</a>
