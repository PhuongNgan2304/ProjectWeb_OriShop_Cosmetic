...
<!-- BEGIN THEME STYLES -->
<link href="${url}/global/css/components1.css" id="style_components"
	rel="stylesheet" type="text/css" />
...
<link rel="stylesheet"
	href="${url}/font-awesome/4.2.0/css/font-awesome.min.css" />

<!-- page specific plugin styles -->
<link rel="stylesheet" href="${url}/css/jquery-ui.min.css" />
<link rel="stylesheet" href="${url}/css/datepicker.min.css" />
<link rel="stylesheet" href="${url}/css/ui.jqgrid.min.css" />
...
<%-- <body class="no-skin"> 
	...
	<!-- page specific plugin scripts -->
		...
		<script src="${url}/js/grid.locale-en.js"></script>
...
<body>
	<table border="1">
		<tr>
			<td colspan ="2"><%@ include file="/commons/admin/header.jsp" %></td>
		</tr>
		<tr>
			<td><decorator:body></decorator:body></td>
		...
		<tr>
			<td colspan ="2"><%@ include file="/commons/admin/footer.jsp" %></td>
		</tr>
	</table>
</body>
</html> --%>