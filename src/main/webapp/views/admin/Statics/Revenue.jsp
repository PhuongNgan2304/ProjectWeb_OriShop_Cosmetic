...
<link rel="stylesheet"
	href="https://cdn.datatables.net/1.13.7/css/jquery.dataTables.min.css">
     ...
     body {
        ...
        .container-fluid {
            padding-left: 15px; /* Khoảng trống bên trái */
            padding-right: 15px; /* Khoảng trống bên phải */
            margin-right: auto;
            margin-left: auto;
            transform: scale(0.5); /* Thu nhỏ kích thước */
        }

        @media (min-width: 576px) {
            .col-lg-9 {
                flex: 0 0 140%; /* Độ rộng của col-lg-9 (2 lần) */
                max-width: 140%;
            }
        }
    
    /* Thêm các điều chỉnh cụ thể cho các phần khác nếu cần */
</style>
