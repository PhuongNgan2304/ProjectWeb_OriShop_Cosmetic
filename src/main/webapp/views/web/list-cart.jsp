						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach items="${cart}" var="map">
									...
									<tr>
										<%-- <c:url value="/image?fname=products/${map.product.images}"
											var="imgUrl"></c:url> --%>
										<%-- <td class="product-in-table"><img class="img-responsive"
											src="${imgUrl}" alt="">
											<div class="product-it-in">
												<h3>${map.product.productname }</h3>
										...
										<td>${map.quantity }</td>
										<td class="shop-red">${map.totalPrice}</td>
										<td>
											<a
											href="<c:url value='/Cart_Product/delete?CartId=${cartid}&id=${map.id}'/>"
										...
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion"
													href="#collapse1"> <i class="fa fa-bus"></i> Thanh toán
													COD
												</a>
											</h4>
										</div>
										<div id="collapse1" class="panel-collapse collapse in">
											<div class="content margin-left-10">
												<label class="container"> <input type="checkbox"
													checked="checked" name="codcheck" id="myCheck"
													onclick="myFunction()"> Thanh toán khi nhận hàng
													(COD)

												</label> <br /> Phương thức này người mua sẽ thanh toán tiền cho
												shipper khi nhận hàng.
											</div>
										</div>
									</div>
											...
											<div class="panel-body cus-form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-sm-8 input-small-field">
														...
														<span class="slash">/</span> <input type="text" name="yy"
															placeholder="YY" class="form-control required">
													</div>
												</div>
												<div class="form-group">
									...
									<div class="panel panel-default">
										...
										<div id="collapseOne-v2" class="panel-collapse collapse in">
											<div class="panel-body">Lorem ipsum dolor sit amet,
												...
												rhoncus elementum orci. Nullam ut sapien ultricies, gravida
												ante ut, ultrices nunc.</div>
										</div>
									</div>
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" class="collapsed"
													data-parent="#accordion-v2" href="#collapseTwo-v2"> Can
													I use gift card to pay for my purchase? </a>
											</h4>
										</div>
						...
						<div class="col-sm-3 col-sm-offset-5">
							<ul class="list-inline total-result">
								...
								<li class="total-price">
									...
									</div> <a style="background: pink; padding: 5px"
									href='<c:url value="/order?cartid=${cartid}"/>'>Thanh toán</a>
								</li>
